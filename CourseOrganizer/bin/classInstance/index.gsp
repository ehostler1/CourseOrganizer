...
<html>
    ...
    <body>
        <a href="#list-classInstance" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-classInstance" class="content scaffold-list" role="main">
            ...
            <f:table collection="${classInstanceList}" />
